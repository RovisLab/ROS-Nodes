...
{
        ros::init(argc, argv, "one_pioneer_paths");
        ros::NodeHandle nh("~");
        ...
        ss = package_string_path + "/resources/global_path_pioneer1_spec.txt";
        plan_path_1.open(ss.c_str());

        ss = package_string_path + "/resources/dwa_single_pioneer_x_and_y_v1_1.txt";
        dwa_path_1.open(ss.c_str());

        ss = package_string_path + "/resources/mpc_single_path.txt";
